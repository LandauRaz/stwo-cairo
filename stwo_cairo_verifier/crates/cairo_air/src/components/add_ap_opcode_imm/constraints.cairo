...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_17_offset_neg_1 = *trace_2_column_17.pop_front().unwrap();
    let trace_2_column_17_offset_0 = *trace_2_column_17.pop_front().unwrap();
    let trace_2_column_17_offset_claimed_sum = *trace_2_column_17.pop_front().unwrap();
    ...
    let constraint_0 = (trace_1_column_4_offset_0) * (trace_1_column_4_offset_0 - (m31(1).into()));

    let constraint_1 = (trace_1_column_5_offset_0) * (trace_1_column_5_offset_0 - (m31(1).into()));

    let constraint_2 = (trace_1_column_5_offset_0) * (trace_1_column_4_offset_0 - (m31(1).into()));
    ...
    let constraint_5 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_17_offset_claimed_sum, trace_2_column_18_offset_claimed_sum,
            trace_2_column_19_offset_claimed_sum, trace_2_column_20_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
...
pub fn intermediate2(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_3_offset_0)
        ...
        + (MemoryIdToBig_alpha4) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha5) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha6) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha7) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha8) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha9) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha10) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha11) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha12) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha13) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha14) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha15) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha16) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha17) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha18) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha19) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha20) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha21) * ((trace_1_column_5_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha22)
            * ((m31(136).into()) * (trace_1_column_4_offset_0) - (trace_1_column_5_offset_0))
        + (MemoryIdToBig_alpha28) * ((trace_1_column_4_offset_0) * (m31(256).into()))
        - (MemoryIdToBig_z)
}
...
pub fn intermediate4(
    ...
    (Opcodes_alpha0) * (trace_1_column_0_offset_0 + m31(2).into())
        + (Opcodes_alpha1)
            * (trace_1_column_1_offset_0
                + trace_1_column_6_offset_0
                + (trace_1_column_7_offset_0) * (m31(512).into())
                + (trace_1_column_8_offset_0) * (m31(262144).into())
                - (trace_1_column_4_offset_0)
                - ((m31(134217728).into()) * (trace_1_column_5_offset_0)))
        + (Opcodes_alpha2) * (trace_1_column_2_offset_0)
        - (Opcodes_z)
}

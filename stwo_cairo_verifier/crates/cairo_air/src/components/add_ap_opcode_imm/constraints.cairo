...
pub fn evaluate_constraints_at_point(
    ...
    // Constrait 0
    let constraint_quotient = ((trace_1_column_9_offset_0) * (trace_1_column_9_offset_0)
    ...
    let constraint_quotient = ((trace_1_column_4_offset_0)
        * (trace_1_column_4_offset_0 - (m31(1).into())))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Impl::from_partial_evals(
        ...
        * ((intermediate2) * (intermediate3))
        - (intermediate3 + (intermediate2) * (trace_1_column_9_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;

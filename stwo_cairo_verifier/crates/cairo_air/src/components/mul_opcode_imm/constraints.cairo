...
pub fn evaluate_constraints_at_point(
    ...
    let mut trace_2_column_125 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_125_offset_0 = *trace_2_column_125.pop_front().unwrap();
    let mut trace_2_column_126 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_126_offset_0 = *trace_2_column_126.pop_front().unwrap();
    let mut trace_2_column_127 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_127_offset_0 = *trace_2_column_127.pop_front().unwrap();
    let mut trace_2_column_128 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_128_offset_0 = *trace_2_column_128.pop_front().unwrap();
    ...
    let trace_2_column_197_offset_neg_1 = *trace_2_column_197.pop_front().unwrap();
    let trace_2_column_197_offset_0 = *trace_2_column_197.pop_front().unwrap();
    let trace_2_column_197_offset_claimed_sum = *trace_2_column_197.pop_front().unwrap();
    let mut trace_2_column_198 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_198_offset_neg_1 = *trace_2_column_198.pop_front().unwrap();
    let trace_2_column_198_offset_0 = *trace_2_column_198.pop_front().unwrap();
    let trace_2_column_198_offset_claimed_sum = *trace_2_column_198.pop_front().unwrap();
    let mut trace_2_column_199 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_199_offset_neg_1 = *trace_2_column_199.pop_front().unwrap();
    let trace_2_column_199_offset_0 = *trace_2_column_199.pop_front().unwrap();
    let trace_2_column_199_offset_claimed_sum = *trace_2_column_199.pop_front().unwrap();
    let mut trace_2_column_200 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_200_offset_neg_1 = *trace_2_column_200.pop_front().unwrap();
    let trace_2_column_200_offset_0 = *trace_2_column_200.pop_front().unwrap();
    let trace_2_column_200_offset_claimed_sum = *trace_2_column_200.pop_front().unwrap();
    ...
    let constraint_2 = (trace_1_column_98_offset_0) * (m31(512).into())
        - (intermediate62 - (trace_1_column_97_offset_0));

    let constraint_3 = (trace_1_column_99_offset_0) * (m31(512).into())
        - (intermediate63 + trace_1_column_98_offset_0);

    let constraint_4 = (trace_1_column_100_offset_0) * (m31(512).into())
        - (intermediate64 + trace_1_column_99_offset_0);

    let constraint_5 = (trace_1_column_101_offset_0) * (m31(512).into())
        - (intermediate65 + trace_1_column_100_offset_0);

    let constraint_6 = (trace_1_column_102_offset_0) * (m31(512).into())
        - (intermediate66 + trace_1_column_101_offset_0);

    let constraint_7 = (trace_1_column_103_offset_0) * (m31(512).into())
        - (intermediate67 + trace_1_column_102_offset_0);

    let constraint_8 = (trace_1_column_104_offset_0) * (m31(512).into())
        - (intermediate68 + trace_1_column_103_offset_0);

    let constraint_9 = (trace_1_column_105_offset_0) * (m31(512).into())
        - (intermediate69 + trace_1_column_104_offset_0);

    let constraint_10 = (trace_1_column_106_offset_0) * (m31(512).into())
        - (intermediate70 + trace_1_column_105_offset_0);

    let constraint_11 = (trace_1_column_107_offset_0) * (m31(512).into())
        - (intermediate71 + trace_1_column_106_offset_0);

    let constraint_12 = (trace_1_column_108_offset_0) * (m31(512).into())
        - (intermediate72 + trace_1_column_107_offset_0);

    let constraint_13 = (trace_1_column_109_offset_0) * (m31(512).into())
        - (intermediate73 + trace_1_column_108_offset_0);

    let constraint_14 = (trace_1_column_110_offset_0) * (m31(512).into())
        - (intermediate74 + trace_1_column_109_offset_0);

    let constraint_15 = (trace_1_column_111_offset_0) * (m31(512).into())
        - (intermediate75 + trace_1_column_110_offset_0);

    let constraint_16 = (trace_1_column_112_offset_0) * (m31(512).into())
        - (intermediate76 + trace_1_column_111_offset_0);

    let constraint_17 = (trace_1_column_113_offset_0) * (m31(512).into())
        - (intermediate77 + trace_1_column_112_offset_0);

    let constraint_18 = (trace_1_column_114_offset_0) * (m31(512).into())
        - (intermediate78 + trace_1_column_113_offset_0);

    let constraint_19 = (trace_1_column_115_offset_0) * (m31(512).into())
        - (intermediate79 + trace_1_column_114_offset_0);

    let constraint_20 = (trace_1_column_116_offset_0) * (m31(512).into())
        - (intermediate80 + trace_1_column_115_offset_0);

    let constraint_21 = (trace_1_column_117_offset_0) * (m31(512).into())
        - (intermediate81 + trace_1_column_116_offset_0);

    let constraint_22 = (trace_1_column_118_offset_0) * (m31(512).into())
        - (intermediate82 + trace_1_column_117_offset_0);

    let constraint_23 = (trace_1_column_119_offset_0) * (m31(512).into())
        - (intermediate83
            - ((m31(136).into()) * (trace_1_column_97_offset_0))
            + trace_1_column_118_offset_0);

    let constraint_24 = (trace_1_column_120_offset_0) * (m31(512).into())
        - (intermediate84 + trace_1_column_119_offset_0);

    let constraint_25 = (trace_1_column_121_offset_0) * (m31(512).into())
        - (intermediate85 + trace_1_column_120_offset_0);

    let constraint_26 = (trace_1_column_122_offset_0) * (m31(512).into())
        - (intermediate86 + trace_1_column_121_offset_0);

    let constraint_27 = (trace_1_column_123_offset_0) * (m31(512).into())
        - (intermediate87 + trace_1_column_122_offset_0);

    let constraint_28 = (trace_1_column_124_offset_0) * (m31(512).into())
        - (intermediate88 + trace_1_column_123_offset_0);

    let constraint_29 = intermediate89
        - ((m31(256).into()) * (trace_1_column_97_offset_0))
        + trace_1_column_124_offset_0;

    let constraint_30 = (QM31Impl::from_partial_evals(
        [
    ...
    let constraint_48 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_197_offset_claimed_sum, trace_2_column_198_offset_claimed_sum,
            trace_2_column_199_offset_claimed_sum, trace_2_column_200_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
    ...
    let constraint_49 = (QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_197_offset_neg_1, trace_2_column_198_offset_neg_1,
                trace_2_column_199_offset_neg_1, trace_2_column_200_offset_neg_1,
            ],
        )

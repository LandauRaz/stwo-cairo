...
pub fn evaluate_constraints_at_point(
    ...
    let mut trace_2_column_98 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_98_offset_0 = *trace_2_column_98.pop_front().unwrap();
    let mut trace_2_column_99 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_99_offset_0 = *trace_2_column_99.pop_front().unwrap();
    let mut trace_2_column_100 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_100_offset_0 = *trace_2_column_100.pop_front().unwrap();
    let mut trace_2_column_101 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_101_offset_0 = *trace_2_column_101.pop_front().unwrap();
    ...
    let trace_2_column_114_offset_neg_1 = *trace_2_column_114.pop_front().unwrap();
    let trace_2_column_114_offset_0 = *trace_2_column_114.pop_front().unwrap();
    let trace_2_column_114_offset_claimed_sum = *trace_2_column_114.pop_front().unwrap();
    let mut trace_2_column_115 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_115_offset_neg_1 = *trace_2_column_115.pop_front().unwrap();
    let trace_2_column_115_offset_0 = *trace_2_column_115.pop_front().unwrap();
    let trace_2_column_115_offset_claimed_sum = *trace_2_column_115.pop_front().unwrap();
    let mut trace_2_column_116 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_116_offset_neg_1 = *trace_2_column_116.pop_front().unwrap();
    let trace_2_column_116_offset_0 = *trace_2_column_116.pop_front().unwrap();
    let trace_2_column_116_offset_claimed_sum = *trace_2_column_116.pop_front().unwrap();
    let mut trace_2_column_117 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_117_offset_neg_1 = *trace_2_column_117.pop_front().unwrap();
    let trace_2_column_117_offset_0 = *trace_2_column_117.pop_front().unwrap();
    let trace_2_column_117_offset_claimed_sum = *trace_2_column_117.pop_front().unwrap();
    ...
    let constraint_2 = (trace_1_column_97_offset_0)
        * (trace_1_column_97_offset_0 - (m31(1).into()));

    let constraint_3 = (intermediate7) * ((intermediate7) * (intermediate7) - (m31(1).into()));

    let constraint_4 = (intermediate8) * ((intermediate8) * (intermediate8) - (m31(1).into()));

    let constraint_5 = (intermediate9) * ((intermediate9) * (intermediate9) - (m31(1).into()));

    let constraint_6 = (intermediate10) * ((intermediate10) * (intermediate10) - (m31(1).into()));

    let constraint_7 = (intermediate11) * ((intermediate11) * (intermediate11) - (m31(1).into()));

    let constraint_8 = (intermediate12) * ((intermediate12) * (intermediate12) - (m31(1).into()));

    let constraint_9 = (intermediate13) * ((intermediate13) * (intermediate13) - (m31(1).into()));

    let constraint_10 = (intermediate14) * ((intermediate14) * (intermediate14) - (m31(1).into()));

    let constraint_11 = (intermediate15) * ((intermediate15) * (intermediate15) - (m31(1).into()));

    let constraint_12 = (intermediate16) * ((intermediate16) * (intermediate16) - (m31(1).into()));

    let constraint_13 = (intermediate17) * ((intermediate17) * (intermediate17) - (m31(1).into()));

    let constraint_14 = (intermediate18) * ((intermediate18) * (intermediate18) - (m31(1).into()));

    let constraint_15 = (intermediate19) * ((intermediate19) * (intermediate19) - (m31(1).into()));

    let constraint_16 = (intermediate20) * ((intermediate20) * (intermediate20) - (m31(1).into()));

    let constraint_17 = (intermediate21) * ((intermediate21) * (intermediate21) - (m31(1).into()));

    let constraint_18 = (intermediate22) * ((intermediate22) * (intermediate22) - (m31(1).into()));

    let constraint_19 = (intermediate23) * ((intermediate23) * (intermediate23) - (m31(1).into()));

    let constraint_20 = (intermediate24) * ((intermediate24) * (intermediate24) - (m31(1).into()));

    let constraint_21 = (intermediate25) * ((intermediate25) * (intermediate25) - (m31(1).into()));

    let constraint_22 = (intermediate26) * ((intermediate26) * (intermediate26) - (m31(1).into()));

    let constraint_23 = (intermediate27) * ((intermediate27) * (intermediate27) - (m31(1).into()));

    let constraint_24 = (intermediate28) * ((intermediate28) * (intermediate28) - (m31(1).into()));

    let constraint_25 = (intermediate29) * ((intermediate29) * (intermediate29) - (m31(1).into()));

    let constraint_26 = (intermediate30) * ((intermediate30) * (intermediate30) - (m31(1).into()));

    let constraint_27 = (intermediate31) * ((intermediate31) * (intermediate31) - (m31(1).into()));

    let constraint_28 = (intermediate32) * ((intermediate32) * (intermediate32) - (m31(1).into()));

    let constraint_29 = (intermediate33) * ((intermediate33) * (intermediate33) - (m31(1).into()));

    let constraint_30 = trace_1_column_67_offset_0
        + trace_1_column_96_offset_0
        + intermediate33
        - (trace_1_column_38_offset_0)
        - ((m31(256).into()) * (trace_1_column_97_offset_0));

    let constraint_31 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_98_offset_0, trace_2_column_99_offset_0, trace_2_column_100_offset_0,
            trace_2_column_101_offset_0,
        ],
    ))
    ...
    let constraint_35 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_114_offset_claimed_sum, trace_2_column_115_offset_claimed_sum,
            trace_2_column_116_offset_claimed_sum, trace_2_column_117_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
    ...
    let constraint_36 = (QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_114_offset_neg_1, trace_2_column_115_offset_neg_1,
                trace_2_column_116_offset_neg_1, trace_2_column_117_offset_neg_1,
            ],
        )

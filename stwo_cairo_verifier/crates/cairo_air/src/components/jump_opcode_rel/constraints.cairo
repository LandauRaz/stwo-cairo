...
pub fn evaluate_constraints_at_point(
    ...
    let constraint_0 = trace_1_column_4_offset_0 + trace_1_column_5_offset_0 - (m31(1).into());

    let constraint_1 = trace_1_column_7_offset_0
        - ((trace_1_column_4_offset_0) * (trace_1_column_2_offset_0)
            + (trace_1_column_5_offset_0) * (trace_1_column_1_offset_0));

    let constraint_2 = (trace_1_column_9_offset_0) * (trace_1_column_9_offset_0 - (m31(1).into()));

    let constraint_3 = (trace_1_column_10_offset_0)
        * (trace_1_column_10_offset_0 - (m31(1).into()));

    let constraint_4 = (trace_1_column_10_offset_0) * (trace_1_column_9_offset_0 - (m31(1).into()));
    ...
    let constraint_7 = (QM31Impl::from_partial_evals(
        [
            ...
            trace_2_column_24_offset_claimed_sum, trace_2_column_25_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);

...
pub fn evaluate_constraints_at_point(
    ...
    let [trace_2_column_52_offset_neg_1, trace_2_column_52_offset_0]: [QM31; 2] =
        (*trace_2_column_52
        .try_into()
        .unwrap())
        .unbox();
    ...
    // Constrait 9
    let constraint_quotient = ((trace_1_column_22_offset_0)
    ...
    // Constrait 11
    let constraint_quotient = ((trace_1_column_27_offset_0)
        * (trace_1_column_27_offset_0 - (m31(1).into())))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;

    // Constrait 12
    let constraint_quotient = ((trace_1_column_28_offset_0)
    ...
    let constraint_quotient = ((QM31Impl::from_partial_evals(
        ...
        * ((intermediate6) * (intermediate7))
        - (intermediate7 + (intermediate6) * (trace_1_column_32_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_49_offset_neg_1, trace_2_column_50_offset_neg_1,
                trace_2_column_51_offset_neg_1, trace_2_column_52_offset_neg_1,
            ],
        ))
        - (QM31Impl::from_partial_evals(
            [

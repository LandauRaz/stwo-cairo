...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_54_offset_neg_1 = *trace_2_column_54.pop_front().unwrap();
    let trace_2_column_54_offset_0 = *trace_2_column_54.pop_front().unwrap();
    let trace_2_column_54_offset_claimed_sum = *trace_2_column_54.pop_front().unwrap();
    let mut trace_2_column_55 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_55_offset_neg_1 = *trace_2_column_55.pop_front().unwrap();
    let trace_2_column_55_offset_0 = *trace_2_column_55.pop_front().unwrap();
    let trace_2_column_55_offset_claimed_sum = *trace_2_column_55.pop_front().unwrap();
    let mut trace_2_column_56 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_56_offset_neg_1 = *trace_2_column_56.pop_front().unwrap();
    let trace_2_column_56_offset_0 = *trace_2_column_56.pop_front().unwrap();
    let trace_2_column_56_offset_claimed_sum = *trace_2_column_56.pop_front().unwrap();
    let mut trace_2_column_57 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_57_offset_neg_1 = *trace_2_column_57.pop_front().unwrap();
    let trace_2_column_57_offset_0 = *trace_2_column_57.pop_front().unwrap();
    let trace_2_column_57_offset_claimed_sum = *trace_2_column_57.pop_front().unwrap();
    ...
    let constraint_0 = (trace_1_column_6_offset_0
        + trace_1_column_7_offset_0
        + trace_1_column_8_offset_0
        + trace_1_column_9_offset_0
        + trace_1_column_10_offset_0
    ...
    let constraint_1 = ((intermediate3) * (intermediate3)
        + trace_1_column_7_offset_0
        + trace_1_column_8_offset_0
        + trace_1_column_9_offset_0
        + trace_1_column_10_offset_0
    ...
    let constraint_2 = (trace_1_column_37_offset_0)
        * (trace_1_column_37_offset_0 - (m31(1).into()));

    let constraint_3 = (trace_1_column_38_offset_0)
        * (trace_1_column_38_offset_0 - (m31(1).into()));

    let constraint_4 = (trace_1_column_38_offset_0)
        * (trace_1_column_37_offset_0 - (m31(1).into()));
    ...
    let constraint_8 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_54_offset_claimed_sum, trace_2_column_55_offset_claimed_sum,
            trace_2_column_56_offset_claimed_sum, trace_2_column_57_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
    ...
    let constraint_9 = (QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_54_offset_neg_1, trace_2_column_55_offset_neg_1,
                trace_2_column_56_offset_neg_1, trace_2_column_57_offset_neg_1,
            ],
        )
...
fn intermediates(
    ...
    let intermediate3 = intermediate3(trace_1_column_6_offset_0);

    let intermediate4 = intermediate4(trace_1_column_27_offset_0);
...
pub fn intermediate3(trace_1_column_6_offset_0: QM31) -> QM31 {
    trace_1_column_6_offset_0 - (m31(1).into())
}

pub fn intermediate4(trace_1_column_27_offset_0: QM31) -> QM31 {
    trace_1_column_27_offset_0 - (m31(136).into())
}

pub fn intermediate5(trace_1_column_33_offset_0: QM31) -> QM31 {
    trace_1_column_33_offset_0 - (m31(256).into())
}
...
pub fn intermediate1(
    ...
    (MemoryAddressToId_alpha0)
        * (trace_1_column_1_offset_0 + trace_1_column_3_offset_0 - (m31(32768).into()))
...
pub fn intermediate6(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_0_offset_0 + m31(1).into())
        + (MemoryAddressToId_alpha1) * (trace_1_column_36_offset_0)
        - (MemoryAddressToId_z)
}
...
pub fn intermediate7(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_36_offset_0)
        + (MemoryIdToBig_alpha1) * (trace_1_column_39_offset_0)
        + (MemoryIdToBig_alpha2) * (trace_1_column_40_offset_0)
        + (MemoryIdToBig_alpha3) * (trace_1_column_41_offset_0)
        + (MemoryIdToBig_alpha4) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha5) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha6) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha7) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha8) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha9) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha10) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha11) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha12) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha13) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha14) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha15) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha16) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha17) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha18) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha19) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha20) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha21) * ((trace_1_column_38_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha22)
            * ((m31(136).into()) * (trace_1_column_37_offset_0) - (trace_1_column_38_offset_0))
        + (MemoryIdToBig_alpha28) * ((trace_1_column_37_offset_0) * (m31(256).into()))
        - (MemoryIdToBig_z)
}
...
pub fn intermediate9(
    ...
    (Opcodes_alpha0)
        * (trace_1_column_0_offset_0
            ...
            - (trace_1_column_37_offset_0)
            - ((m31(134217728).into()) * (trace_1_column_38_offset_0)))

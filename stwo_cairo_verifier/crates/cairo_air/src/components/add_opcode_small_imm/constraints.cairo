...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_44_offset_neg_1 = *trace_2_column_44.pop_front().unwrap();
    let trace_2_column_44_offset_0 = *trace_2_column_44.pop_front().unwrap();
    let trace_2_column_44_offset_claimed_sum = *trace_2_column_44.pop_front().unwrap();
    let mut trace_2_column_45 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_45_offset_neg_1 = *trace_2_column_45.pop_front().unwrap();
    let trace_2_column_45_offset_0 = *trace_2_column_45.pop_front().unwrap();
    let trace_2_column_45_offset_claimed_sum = *trace_2_column_45.pop_front().unwrap();
    let mut trace_2_column_46 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_46_offset_neg_1 = *trace_2_column_46.pop_front().unwrap();
    let trace_2_column_46_offset_0 = *trace_2_column_46.pop_front().unwrap();
    let trace_2_column_46_offset_claimed_sum = *trace_2_column_46.pop_front().unwrap();
    let mut trace_2_column_47 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_47_offset_neg_1 = *trace_2_column_47.pop_front().unwrap();
    let trace_2_column_47_offset_0 = *trace_2_column_47.pop_front().unwrap();
    let trace_2_column_47_offset_claimed_sum = *trace_2_column_47.pop_front().unwrap();
    ...
    let constraint_0 = trace_1_column_8_offset_0
        - ((trace_1_column_5_offset_0) * (trace_1_column_2_offset_0)
            + (m31(1).into() - (trace_1_column_5_offset_0)) * (trace_1_column_1_offset_0));

    let constraint_1 = trace_1_column_9_offset_0
        - ((trace_1_column_6_offset_0) * (trace_1_column_2_offset_0)
            + (m31(1).into() - (trace_1_column_6_offset_0)) * (trace_1_column_1_offset_0));

    let constraint_2 = (trace_1_column_11_offset_0)
        * (trace_1_column_11_offset_0 - (m31(1).into()));

    let constraint_3 = (trace_1_column_12_offset_0)
        * (trace_1_column_12_offset_0 - (m31(1).into()));

    let constraint_4 = (trace_1_column_12_offset_0)
        * (trace_1_column_11_offset_0 - (m31(1).into()));

    let constraint_5 = (trace_1_column_17_offset_0)
        * (trace_1_column_17_offset_0 - (m31(1).into()));

    let constraint_6 = (trace_1_column_18_offset_0)
        * (trace_1_column_18_offset_0 - (m31(1).into()));

    let constraint_7 = (trace_1_column_18_offset_0)
        * (trace_1_column_17_offset_0 - (m31(1).into()));

    let constraint_8 = (trace_1_column_23_offset_0)
        * (trace_1_column_23_offset_0 - (m31(1).into()));

    let constraint_9 = (trace_1_column_24_offset_0)
        * (trace_1_column_24_offset_0 - (m31(1).into()));

    let constraint_10 = (trace_1_column_24_offset_0)
        * (trace_1_column_23_offset_0 - (m31(1).into()));

    let constraint_11 = trace_1_column_13_offset_0
        + (trace_1_column_14_offset_0) * (m31(512).into())
        + (trace_1_column_15_offset_0) * (m31(262144).into())
        - (trace_1_column_11_offset_0)
        - ((m31(134217728).into()) * (trace_1_column_12_offset_0))
        - (trace_1_column_19_offset_0
            + (trace_1_column_20_offset_0) * (m31(512).into())
            + (trace_1_column_21_offset_0) * (m31(262144).into())
            - (trace_1_column_17_offset_0)
            - ((m31(134217728).into()) * (trace_1_column_18_offset_0))
            + trace_1_column_25_offset_0
            + (trace_1_column_26_offset_0) * (m31(512).into())
            + (trace_1_column_27_offset_0) * (m31(262144).into())
            - (trace_1_column_23_offset_0)
            - ((m31(134217728).into()) * (trace_1_column_24_offset_0)));
    ...
    let constraint_16 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_44_offset_claimed_sum, trace_2_column_45_offset_claimed_sum,
            trace_2_column_46_offset_claimed_sum, trace_2_column_47_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
...
pub fn intermediate2(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_10_offset_0)
        ...
        + (MemoryIdToBig_alpha4) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha5) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha6) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha7) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha8) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha9) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha10) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha11) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha12) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha13) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha14) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha15) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha16) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha17) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha18) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha19) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha20) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha21) * ((trace_1_column_12_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha22)
            * ((m31(136).into()) * (trace_1_column_11_offset_0) - (trace_1_column_12_offset_0))
        + (MemoryIdToBig_alpha28) * ((trace_1_column_11_offset_0) * (m31(256).into()))
        - (MemoryIdToBig_z)
}
...
pub fn intermediate3(
    ...
    (MemoryAddressToId_alpha0)
        * (trace_1_column_9_offset_0 + trace_1_column_4_offset_0 - (m31(32768).into()))
        + (MemoryAddressToId_alpha1) * (trace_1_column_16_offset_0)
        - (MemoryAddressToId_z)
}
...
pub fn intermediate4(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_16_offset_0)
        ...
        + (MemoryIdToBig_alpha4) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha5) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha6) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha7) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha8) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha9) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha10) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha11) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha12) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha13) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha14) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha15) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha16) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha17) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha18) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha19) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha20) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha21) * ((trace_1_column_18_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha22)
            * ((m31(136).into()) * (trace_1_column_17_offset_0) - (trace_1_column_18_offset_0))
        + (MemoryIdToBig_alpha28) * ((trace_1_column_17_offset_0) * (m31(256).into()))
        - (MemoryIdToBig_z)
}
...
pub fn intermediate6(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_22_offset_0)
        ...
        + (MemoryIdToBig_alpha4) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha5) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha6) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha7) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha8) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha9) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha10) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha11) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha12) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha13) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha14) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha15) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha16) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha17) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha18) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha19) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha20) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha21) * ((trace_1_column_24_offset_0) * (m31(511).into()))
        + (MemoryIdToBig_alpha22)
            * ((m31(136).into()) * (trace_1_column_23_offset_0) - (trace_1_column_24_offset_0))
        + (MemoryIdToBig_alpha28) * ((trace_1_column_23_offset_0) * (m31(256).into()))
        - (MemoryIdToBig_z)
}

...
pub fn evaluate_constraints_at_point(
    ...
    // Constrait 0
    let constraint_quotient = ((trace_1_column_28_offset_0) * (trace_1_column_28_offset_0)
    ...
    // Constrait 9
    let constraint_quotient = ((trace_1_column_23_offset_0)
    ...
    let constraint_quotient = ((QM31Impl::from_partial_evals(
        ...
        * ((intermediate6) * (intermediate7))
        - (intermediate7 + (intermediate6) * (trace_1_column_28_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                ...
                trace_2_column_47_offset_neg_1, trace_2_column_48_offset_neg_1,
            ],
        ))
        - (QM31Impl::from_partial_evals(
            [

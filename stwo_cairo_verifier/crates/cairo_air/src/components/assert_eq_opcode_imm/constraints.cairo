...
pub fn evaluate_constraints_at_point(
    ...
    let mut trace_2_column_8 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_8_offset_0 = *trace_2_column_8.pop_front().unwrap();
    ...
    let trace_2_column_16_offset_claimed_sum = *trace_2_column_16.pop_front().unwrap();
    ...
    let constraint_1 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_8_offset_0, trace_2_column_9_offset_0, trace_2_column_10_offset_0,
            trace_2_column_11_offset_0,
        ],
    ))
    ...
    let constraint_3 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_16_offset_claimed_sum, trace_2_column_17_offset_claimed_sum,

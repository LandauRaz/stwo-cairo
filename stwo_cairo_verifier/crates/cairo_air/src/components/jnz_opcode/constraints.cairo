...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_42_offset_neg_1 = *trace_2_column_42.pop_front().unwrap();
    let trace_2_column_42_offset_0 = *trace_2_column_42.pop_front().unwrap();
    let trace_2_column_42_offset_claimed_sum = *trace_2_column_42.pop_front().unwrap();
    let mut trace_2_column_43 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_43_offset_neg_1 = *trace_2_column_43.pop_front().unwrap();
    let trace_2_column_43_offset_0 = *trace_2_column_43.pop_front().unwrap();
    let trace_2_column_43_offset_claimed_sum = *trace_2_column_43.pop_front().unwrap();
    ...
    let constraint_3 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_42_offset_claimed_sum, trace_2_column_43_offset_claimed_sum,
    ...
    let constraint_4 = (QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_42_offset_neg_1, trace_2_column_43_offset_neg_1,

...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_32_offset_neg_1 = *trace_2_column_32.pop_front().unwrap();
    let trace_2_column_32_offset_0 = *trace_2_column_32.pop_front().unwrap();
    let trace_2_column_32_offset_claimed_sum = *trace_2_column_32.pop_front().unwrap();
    let mut trace_2_column_33 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_33_offset_neg_1 = *trace_2_column_33.pop_front().unwrap();
    let trace_2_column_33_offset_0 = *trace_2_column_33.pop_front().unwrap();
    let trace_2_column_33_offset_claimed_sum = *trace_2_column_33.pop_front().unwrap();
    let mut trace_2_column_34 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_34_offset_neg_1 = *trace_2_column_34.pop_front().unwrap();
    let trace_2_column_34_offset_0 = *trace_2_column_34.pop_front().unwrap();
    let trace_2_column_34_offset_claimed_sum = *trace_2_column_34.pop_front().unwrap();
    ...
    let constraint_0 = trace_1_column_5_offset_0
        + (trace_1_column_6_offset_0) * (m31(512).into())
        + (trace_1_column_7_offset_0) * (m31(262144).into())
        - (trace_1_column_2_offset_0);
    ...
    let constraint_6 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_32_offset_claimed_sum, trace_2_column_33_offset_claimed_sum,
            trace_2_column_34_offset_claimed_sum, trace_2_column_35_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
    ...
    let constraint_7 = (QM31Impl::from_partial_evals(
        ...
        - (QM31Impl::from_partial_evals(
            [
                trace_2_column_32_offset_neg_1, trace_2_column_33_offset_neg_1,
...
pub fn intermediate2(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_4_offset_0)
        + (MemoryIdToBig_alpha1) * (trace_1_column_5_offset_0)
        + (MemoryIdToBig_alpha2) * (trace_1_column_6_offset_0)
